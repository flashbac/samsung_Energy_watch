...
<p>Daten hinzufügen: <a href="<?php echo site_url("data/putValue/22/20.21"); ?>">PutValue MeterID 1 Value 20.21</a></p>
<p>Letzen Wert lesen: <a href="<?php echo site_url("data/getLastValue/22"); ?>">getLastValue von MeterID 22</a></p>
